...
-(void)setMosaicData:(MosaicData *)newMosaicData{
    ...
    if ([_mosaicData.imageFilename hasPrefix:@"http://"] ||
        ...
        void (^imageSuccess)(AFHTTPRequestOperation *operation, id responseObject) = ^(AFHTTPRequestOperation *operation, id responseObject) {
        ...
        AFHTTPRequestOperation *requestOperation = [[AFHTTPRequestOperation alloc] initWithRequest:anURLRequest];
        requestOperation.responseSerializer = [AFImageResponseSerializer serializer];
        
        [requestOperation setCompletionBlockWithSuccess:imageSuccess
